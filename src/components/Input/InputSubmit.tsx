...
const InputSubmit = React.forwardRef<HTMLInputElement, React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>>(
  ({ className, ...props }, ref) => {
    ...
    const handleFileInput = async () => {
      ...
      setUrl(await fileToBase64(file));
    };
